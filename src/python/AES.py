...
# Modified by Jeffrey Shen to allow for variable round numbers
#
import os
import sys
import math
...
class AES(object):
    ...
    def encrypt(self, iput, key, size, nbrRounds = None):
        ...
        # set the number of rounds if not set
        if nbrRounds == None:
    ...
    def decrypt(self, iput, key, size, nbrRounds = None):
        output = [0] * 16
